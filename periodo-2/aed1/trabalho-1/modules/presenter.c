...
void escolher_tela() {
    ...
    switch(tela_selecionada) {
        ...
        case 5: system("clear"); tela_cadastro_inicio(); break;

        case 6: system("clear"); tela_cadastro_fim(); break;

        case 7: system("clear"); tela_cadastro_posicao_especifica(); break;

        case 8: system("clear"); tela_remocao(); break;
        
        case 9: system("clear"); tela_visualizar_detalhes(); break;

        case 10: system("clear"); tela_inicial(); break;
